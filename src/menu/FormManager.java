...
public class FormManager {
    ...
    static void updateMenuItemLabel(int i, String label) {
    ...
    if (isNewFormAble()) {
        ...
        if (instance.menuShowing == true) {
            ...
            // Change to use a default transition instead of switch form transition
            instance.panelSlider.addSlide(instance.mainForm, SimpleTransition.getDefaultTransition(false));
        } else {
